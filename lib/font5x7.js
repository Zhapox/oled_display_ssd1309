...
function accentUpper(baseCode, accent) {
  var base = FONT_DATA[baseCode - 32];
  if (!base) return [0, 0, 0, 0, 0];
  return [((base[0] << 1) & 0x7E) | accent[0],
          ((base[1] << 1) & 0x7E) | accent[1],
          ((base[2] << 1) & 0x7E) | accent[2],
          ((base[3] << 1) & 0x7E) | accent[3],
          ((base[4] << 1) & 0x7E) | accent[4]];
}

var EXTENDED = {};

// Uppercase accented
EXTENDED[192] = accentUpper(65, ACCENT.grave);      // À
EXTENDED[193] = accentUpper(65, ACCENT.acute);      // Á
EXTENDED[194] = accentUpper(65, ACCENT.circumflex); // Â
EXTENDED[195] = accentUpper(65, ACCENT.tilde);      // Ã
EXTENDED[196] = accentUpper(65, ACCENT.umlaut);     // Ä
EXTENDED[197] = accentUpper(65, ACCENT.ring);       // Å
EXTENDED[198] = [0x7E, 0x09, 0x7F, 0x49, 0x41];    // Æ
EXTENDED[199] = [0x3E, 0x41, 0x41, 0x61, 0x22];    // Ç
EXTENDED[200] = accentUpper(69, ACCENT.grave);      // È
EXTENDED[201] = accentUpper(69, ACCENT.acute);      // É
EXTENDED[202] = accentUpper(69, ACCENT.circumflex); // Ê
EXTENDED[203] = accentUpper(69, ACCENT.umlaut);     // Ë
EXTENDED[204] = accentUpper(73, ACCENT.grave);      // Ì
EXTENDED[205] = accentUpper(73, ACCENT.acute);      // Í
EXTENDED[206] = accentUpper(73, ACCENT.circumflex); // Î
EXTENDED[207] = accentUpper(73, ACCENT.umlaut);     // Ï
EXTENDED[208] = [0x7F, 0x49, 0x41, 0x22, 0x1C];    // Ð
EXTENDED[209] = accentUpper(78, ACCENT.tilde);      // Ñ
EXTENDED[210] = accentUpper(79, ACCENT.grave);      // Ò
EXTENDED[211] = accentUpper(79, ACCENT.acute);      // Ó
EXTENDED[212] = accentUpper(79, ACCENT.circumflex); // Ô
EXTENDED[213] = accentUpper(79, ACCENT.tilde);      // Õ
EXTENDED[214] = accentUpper(79, ACCENT.umlaut);     // Ö
EXTENDED[215] = [0x22, 0x14, 0x08, 0x14, 0x22];    // ×
EXTENDED[216] = [0x3E, 0x51, 0x49, 0x45, 0x3E];    // Ø
EXTENDED[217] = accentUpper(85, ACCENT.grave);      // Ù
EXTENDED[218] = accentUpper(85, ACCENT.acute);      // Ú
EXTENDED[219] = accentUpper(85, ACCENT.circumflex); // Û
EXTENDED[220] = accentUpper(85, ACCENT.umlaut);     // Ü
EXTENDED[221] = accentUpper(89, ACCENT.acute);      // Ý
EXTENDED[223] = [0x7E, 0x01, 0x49, 0x49, 0x36];    // ß
...
EXTENDED[230] = [0x20, 0x54, 0x78, 0x54, 0x18];    // æ
EXTENDED[231] = [0x38, 0x44, 0x44, 0x64, 0x20];    // ç
...
EXTENDED[248] = [0x38, 0x64, 0x54, 0x4C, 0x38];    // ø
